  ...
  <div class="order">
    <div class="product-info-header" style="display:flex;align-items: center;" shadow="hover">
      <div class="product-img">
        <img :src="leaseOrder.post_pics && leaseOrder.post_pics.length > 0 ? leaseOrder.post_pics[0] : ''" alt="product image">
      </div>
...
const handelClick = async(order_status) => {
  ...
  .product-info-header {
    ...
    .product-img img {
      min-width: 100%; /* 使图片宽度不超过容器宽度 */
      min-height: 100%; /* 使图片高度不超过容器高度 */
